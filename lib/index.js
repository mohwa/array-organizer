 ...
 * @example
 * forEach([1, 2, 3], function(v, k) {}, this);
 */
export { forEach };
 ...
 * @returns {Array}
 * @example
 * toArray([1, 2, 3], function(v, k) { return { v, vv: this }; }, this);
 */
export { toArray };
 ...
 * @returns {Array}
 * @example
 * concat({ x: 1, y: 2, z: 3 }, { xx: 1, yy: 2, zz: 3 }, { xxx: 1, yyy: 2, zzz: 3 })
 */
 ...
 * @returns {number}
 * @example
 * findIndex(['1', 2, 3], v => isNumber(v), this)
 */
 ...
 * @returns {*}
 * @example
 * deepFind([{ x: { xx: { y: 3, z: 'A' }}}], v => isNumber(v), this)
 */
 ...
 * @returns {Array}
 * @example
 * flatMap(['1', [2, 3, 4], [5, 6, 7, [8, 9]]], v => v.slice(0), this)
 */
